...
IF EXIST "%SCRIPT_PATH%config.xml" TYPE "%SCRIPT_PATH%config.xml" | findstr /c:"<folder id=" /c:"encryptionPassword" | findstr /v /c:"<encryptionPassword></encryptionPassword>" | findstr /v /c:"<folder id=""""" | ..\psreplace ".*label=" "" | ..\psreplace "path=.*" ""
echo.
pause
echo.
echo ==========================================================
